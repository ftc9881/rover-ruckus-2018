 ...
 * and a for loop.
 */
@Autonomous(name = "AutoAlt", group = "MaximumOverdrive")
public class AutoAlt extends UnitBotMain
{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive(new SimpleDriver(.3, 85, null), false, true);
        pivot(-3150);
        extend(500);
        _servoGrab1.setPosition(.85);
        sleep(500);
        _servoGrab1.setPosition(.4);
        turn(new IMUTurner(initialHeading - getCurrentHeading(), .6, _imu1, 1, null), true, true);
//
        //go to crater for park

        _motorIntake.setPower(0);
        extend(-500);
        pivot(3600);
        turn(new IMUTurner(35, .4, _imu1, 1, null), true, true);
        drive(new SimpleDriver(-.7, 2000, null), false, true);
        turn(new IMUTurner(-100, .4, _imu1, 1, null), true, true);
//
        //park
